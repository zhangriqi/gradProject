...
parser.add_argument("--domain", dest="domain", type=str, metavar='<str>', default='2015-2016', help="domain of the corpus {2015-2016}")
...
for ii in range(args.epochs):
    ...
    for b in tqdm(range(batches_per_epoch)):
        ...
        batch_loss, batch_max_margin_loss = model.train_on_batch([sen_input, neg_input], np.ones((args.batch_size, args.batch_size, 1)))
